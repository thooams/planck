...
[_BEPO] = {
  ...
  {LOWER,   KC_LCTL,    KC_LGUI,    BP_ALGR, KC_SPC , KC_TAB,      KC_BSPC,           KC_ENT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT}
},
...
[_LOWER] = {
  ...
  {_______, _______, _______,     LCTL(KC_F2), _______,     _______,     KC_BSPC,      KC_ENT,      _______,  _______, _______,  _______}
},
